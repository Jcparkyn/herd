const csvString = `city_name,population,area_sq_km,average_income,median_home_price,number_of_schools
...
for (let run = 0; run < 20000; run++) {
  ...
  for (const record of parsed) {
    totalPopulation += parseFloat(record['population']);
  }
}

console.log(`Total population over 20000 runs: ${totalPopulation}`);