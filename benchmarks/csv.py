csv_string = """city_name,population,area_sq_km,average_income,median_home_price,number_of_schools
...
for run in range(20000):
    parsed = parse_csv(csv_string)
    for record in parsed:
        total_population = total_population + float(record["population"])

print(f"Total population over 20000 runs: {total_population}")
